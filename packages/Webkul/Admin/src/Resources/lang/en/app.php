...
return [
    ...
    'components' => [
        ...
        'layouts' => [
            'powered-by' => [
                'description' => 'Powered by Java CRM.',
            ],
        ...
        'roles' => [
            'index' => [
                ...
                'show' => [
                    ...
                    'permission-type'          => 'Permission Type',
                    'permissions-title'        => 'System Permissions & Access Rights',
                    'all-permissions-notice'   => 'This role has full access to all system features without restriction.',
                    'custom-permissions-notice'=> 'List of permissions granted to this role:',
                    'users-title'              => 'Assigned Users',
        ...
        'pipelines' => [
            'index' => [
                ...
                'show' => [
                    ...
                    'back-btn'          => 'Back to Pipelines',
                    'edit-btn'          => 'Edit Pipeline',
                    'subtitle'          => 'Details of sales stages and lead statistics.',
                    'total-stages'      => 'Total Stages',
                    'total-leads'       => 'Total Active Leads',
                    'rotten-days'       => 'Rotten Days Limit',
                    'info-title'        => 'Pipeline Information',
                    'info-subtitle'     => 'Sales pipeline parameters.',
                    'pipeline-name'     => 'Pipeline Name',
                    'default-status'    => 'Default Status',
                    'default-yes'       => 'Yes (Default)',
                    'default-no'        => 'Standard',
                    'total-value'       => 'Total Potential Value',
                    'created-at'        => 'Created At',
                    'stages-title'      => 'Sales Stages',
                    'stages-subtitle'   => 'Pipeline order and win probability estimation per stage.',
                    'order'             => 'Order',
                    'stage-name'        => 'Stage Name',
                    'stage-code'        => 'Stage Code',
                    'probability'       => 'Probability',
                    'leads-count'       => 'Lead Count',
                    'stage-total-value' => 'Total Value',
                    'empty-stages'      => 'No stages found in this pipeline.',
                ],
            ],
    ...
    'super_admin' => [
        ...
        'dashboard' => [
            ...
            'description'       => 'Monitor overall JavaCRM platform performance and health in real-time',
            ...
            'of_total'          => 'of total',
            'tenant_growth'     => 'Tenant Growth (6 Months)',
            'tenant_growth_sub' => 'Active tenant count over the last 6 months',
            'plan_distribution' => 'Plan Distribution',
            'plan_dist_sub'     => 'Tenant proportion per subscription plan',
            'revenue_overview'  => 'Revenue Overview',
            'revenue_sub'       => 'Platform revenue per month',
            'invoice_status'    => 'Invoice Status Summary',
            ...
            'mrr_sub'           => 'Estimated active monthly revenue',
            'arr'               => 'ARR (Annual Recurring)',
            'arr_sub'           => 'Annual projection (MRR x 12)',
            'arpu'              => 'ARPU (Average / Tenant)',
            'arpu_sub'          => 'Average revenue per tenant',
            'churn_rate'        => 'Churn Rate (30 Days)',
            'churn_sub'         => 'Cancellation & expiration rate',
            ...
            'health_score_sub'  => 'Tenant activity & churn risk analytics',
            'customer_health'   => 'Tenant Health',
            'healthy_all'       => 'All tenants are in healthy condition.',
            'health_score'      => 'Health Score',
            'category'          => 'Category',
            'audit_trail_title' => 'Super Admin Audit Trail Log',
            'audit_trail_sub'   => '5 recent administrative activities',
            'all_logs'          => 'All Logs →',
            'empty_audit_logs'  => 'No activity logs recorded yet.',
            'total_invoices_label' => 'Total Invoices',
            'recent_tenants_sub'   => '5 recent joined companies',
            'no_tenants'           => 'No tenants registered yet',
            'recent_invoices_sub'  => '5 recent invoices created',
            'no_invoices'          => 'No invoices yet',
            'amount'               => 'Amount',
        ],
        'companies' => [
            'title'              => 'Manage Companies (Tenants)',
            'description'        => 'Manage all registered companies on the JavaCRM platform',
            'create_title'       => 'Add New Company (Tenant)',
            'create_desc'        => 'Create a new tenant along with the initial admin account for the company.',
            'edit_title'         => 'Edit Company (Tenant)',
            'edit_desc'          => 'Update company details for :name.',
            'show_title'         => 'Company Details: :name',
            'show_title_meta'    => 'Company Tenant Details - :name',
            'profile'            => 'Company Profile',
            'add_btn'            => 'Add Company',
            'company_list'       => 'Registered Companies List',
            'empty'              => 'No companies registered yet.',
            'create_first'       => 'Add the first company',
            'name'               => 'Company Name',
            ...
            'detail'             => 'Detail',
            'delete'             => 'Delete',
            'delete_confirm'     => 'WARNING: All data for company :name (users, leads, invoices, subscriptions) will be permanently deleted. Continue?',
            'company_info'       => 'Company Information',
            'company_email'      => 'Company Email',
            'initial_admin'      => 'Initial Admin (Company Admin)',
            'initial_admin_note' => 'This user will be the first admin for the tenant. Default password: password123',
            ...
            'cancel'             => 'Cancel',
            'back'               => 'Back',
            'users_list'         => 'Company Users List',
            'users_list_sub'     => 'CRM users registered under this tenant.',
            'no_users'           => 'No users registered in this company yet.',
            'billing_history'    => 'Billing & Payment History',
            'billing_history_sub' => 'List of all subscription payment invoices for this tenant.',
            'no_invoices'        => 'No billing history for this company yet.',
            'quota_usage'        => 'Quota Usage',
            'team_members'       => 'Team Members / Users',
            'used'               => 'Used',
            'no_plan'            => 'No Plan',
        ],
        'plans' => [
            'title'             => 'Manage Plans',
            'description'       => 'Manage subscription plans available for all tenants.',
            'create_title'      => 'Add New Subscription Plan',
            'create_desc'       => 'Create a new subscription plan for JavaCRM tenants.',
            'edit_title'        => 'Edit Plan Configuration',
            'edit_desc'         => 'Modify plan limits and pricing for :name.',
            'add_btn'           => 'Add Plan',
            'plan_list'         => 'Subscription Plans List',
            'name'              => 'Plan Name',
            'code'              => 'Code',
            'code_hint'         => 'Unique code (lowercase, numbers, hyphens)',
            'price'             => 'Price (IDR)',
            'user_limit'        => 'User Limit',
            'lead_limit'        => 'Leads Limit',
            ...
            'max_users'         => 'Max Users',
            'max_users_sub'     => 'Number of users per tenant',
            'max_leads'         => 'Max Leads',
            'max_leads_sub'     => 'Maximum leads allowed',
            'max_storage'       => 'Max Storage (MB)',
            'max_storage_sub'   => 'Storage capacity',
            'summary'           => 'Summary',
            'summary_note'      => 'Plans created will be immediately Active and available for selection by new tenants.',
            'save'              => 'Create Plan',
            'update'            => 'Save Changes',
            'cancel'            => 'Cancel',
            'back'              => 'Back',
        ...
        'invoices' => [
            ...
            'description'       => 'Monitor and manage all tenant payment transactions.',
            'detail_title'      => 'Invoice Detail #:number',
            'detail_desc'       => 'Payment transaction details for tenant :name',
            'invoice_id'        => 'Invoice',
            ...
            'mark_paid_confirm' => 'Mark invoice #:number as Paid?',
            'paid'              => 'Paid',
            'pending'           => 'Pending',
            'failed'            => 'Failed',
            'expired'           => 'Expired',
            ...
            'filter'            => 'Filter',
            'reset'             => 'Reset',
            'empty'             => 'No invoices or billing records found.',
            'billing_info'      => 'Billing Information',
            'billing_info_sub'  => 'Details regarding payment transaction and tenant.',
            'payment_details'   => 'Payment Details',
            'payment_method'    => 'Payment Method',
            'currency'          => 'Currency',
            'raw_metadata'      => 'RAW Metadata Callback',
            'raw_metadata_desc' => 'Raw response sent by Xendit payment gateway.',
            'payment_gateway'   => 'Payment Gateway',
            'back'              => 'Back',
            'base_price'        => 'Base Price',
            'no_metadata'       => 'No callback metadata stored.',
