...
class Installer extends Command
{
     ...
     * @var string
     */
    protected $signature = 'java-crm:install
     ...
     * @var string
     */
    protected $description = 'Java CRM installer.';
    ...
    /**
     * Install and configure Java CRM.
     */
    public function handle()
    {
        ...
        $this->warn('Step: Seeding basic data for Java CRM kickstart...');
        $this->info(app(JavaCrmDatabaseSeeder::class)->run([
    ...
    protected function createAdminCredentials()
    {
        ...
        try {
            ...
            File::put($filePath, 'Java CRM is successfully installed');

            $this->info('-----------------------------');
            $this->info('Congratulations!');
            $this->info('The installation has been finished and you can now use Java CRM.');
